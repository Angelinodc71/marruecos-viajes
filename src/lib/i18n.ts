...
const de = {
  nav: { destinos: "Reiseziele", packs: "Pakete", alojamientos: "Unterkünfte", experiencias: "Erlebnisse", sobre: "Über uns", contacto: "Kontakt", inicio: "Startseite" },
  cta: { reservar: "Jetzt buchen", verPacks: "Pakete ansehen", verTodos: "Alle Pakete ansehen", contactar: "Experten kontaktieren", planificar: "Meine Reise planen", buscar: "Reise suchen", favoritos: "Zu Favoriten hinzufügen", compartir: "Teilen", compartido: "Link kopiert!", verDetalles: "Details ansehen", filtrar: "Filtern", limpiar: "Filter zurücksetzen", enviar: "Nachricht senden" },
  hero: { eyebrow: "Marokko · Authentische Reisen", title1: "Entdecke Marokko", title2: "wie noch nie zuvor", subtitle: "Rundumreisen: Transfers, Riads, authentische Erlebnisse und persönliche Betreuung.", destino: "Reiseziel", destinoPh: "Wohin möchten Sie reisen?", fechas: "Reisedaten", personas: "Reisende" },
  sections: { destinosEyebrow: "Beliebte Reiseziele", destinosTitle: "Orte zum Verlieben", packsEyebrow: "Beliebteste Pakete", packsTitle: "Dein nächstes Abenteuer", ctaEyebrow: "Etwas Individuelles gesucht?", ctaTitle: "Wir gestalten Ihre Traumreise", ctaText: "Erzählen Sie uns Ihre Daten, Interessen und Ihr Budget. Wir entwerfen ein einzigartiges Reiseprogramm für Sie.", readyEyebrow: "Bereit für Ihr Abenteuer?", readyTitle: "Entdecken Sie unsere Pakete und erleben Sie Marokko in vollen Zügen." },
  bullets: { precio: "Bestpreis garantiert", atencion: "24/7 Support", personal: "100% personalisierte Reisen", sinCargos: "Keine versteckten Kosten", pago: "Sichere Zahlung" },
  ...
  footer: { tagline: "Ihr Marokko-Abenteuer beginnt hier", about: "Spezialisten für authentische Reisen durch Marokko. Riads, Wüste, Gastronomie und Kultur.", destinos: "Reiseziele", paginas: "Seiten", boletin: "Newsletter", boletinText: "Erhalten Sie exklusive Angebote und Neuigkeiten aus Marokko.", emailPh: "Ihre E-Mail", rights: "© 2026 Marruecos Viajes Auténticos. Alle Rechte vorbehalten.", privacy: "Datenschutzrichtlinie", terms: "Allgemeine Geschäftsbedingungen" },
  packs: { metaTitle: "Marokko-Reisepakete — Alles inklusive", heroEyebrow: "Alles inklusive", heroTitle: "Unsere Reisepakete", heroDesc: "Transfer, Unterkunft, Erlebnisse und lokaler Reiseführer — jedes Detail liebevoll geplant.", duration: "Dauer", anyDuration: "Beliebige Dauer", price: "Preis", anyPrice: "Beliebiger Preis", city: "Stadt", anyCity: "Alle Städte", expType: "Erlebnistyp", anyType: "Alle Erlebnisse", days1to3: "1-3 Tage", days4to6: "4-6 Tage", days7plus: "7+ Tage", priceLt: "Günstig", priceMid: "Standard", priceGt: "Premium", noResults: "Keine Pakete für diese Filter", popular: "Beliebt", from: "ab", nights: "Nächte", results: "Ergebnis", results_plural: "Ergebnisse" },
  stays: { metaTitle: "Unterkünfte in Marokko — Riads, Hotels und Boutique", heroEyebrow: "Wo übernachten", heroTitle: "Einzigartige Unterkünfte in Marokko", heroDesc: "Traditionelle Riads, Boutique-Hotels und unvergessliche Erlebnisse.", destination: "Reiseziel", anyDest: "Alle Reiseziele", typeLabel: "Unterkunftstyp", anyTypeLabel: "Alle", maxPrice: "Höchstpreis", perNight: "/Nacht", services: "Leistungen", anyService: "Alle Leistungen", noResults: "Keine Unterkünfte für diese Filter", reviews: "Bewertungen" },
  experiences: { metaTitle: "Erlebnisse in Marokko — Spas, Touren und Gastronomie", heroEyebrow: "Das Authentische erleben", heroTitle: "Typisch marokkanische Erlebnisse", heroDesc: "Traditionelle Hammams, Gastronomie, Medina-Touren und Wüstenabenteuer.", noResults: "Keine Erlebnisse in dieser Kategorie" },
  destinos: { metaTitle: "Reiseziele in Marokko — Marrakesch, Fès, Chefchaouen und mehr", heroEyebrow: "Erkunden", heroTitle: "Unverzichtbare Reiseziele", heroDesc: "Von mittelalterlichen Medinas bis zu den endlosen Dünen der Sahara.", selectPrompt: "Klicken Sie auf ein Reiseziel, um alles Verfügbare zu sehen", packsHere: "Pakete an diesem Reiseziel", staysHere: "Verfügbare Unterkünfte", expsHere: "Erlebnisse vor Ort", viewAll: "Alle ansehen", noItems: "Weitere Optionen bald verfügbar" },
  about: { metaTitle: "Über uns — Marruecos Viajes Auténticos", heroEyebrow: "Wer wir sind", heroTitle: "Experten für unvergessliche Reisen", heroDesc: "Wir sind ein lokales Team, das die Magie und Authentizität Marokkos teilen möchte.", missionTitle: "Unsere Mission", missionP1: "Einzigartige, personalisierte Erlebnisse anbieten und dabei jeden Detail berücksichtigen, damit Sie Marokko auf die authentischste Weise erleben.", missionP2: "Wir arbeiten mit lokalen Reiseführern, familiengeführten Riads und Handwerkern des Landes zusammen, damit Ihre Reise Seele hat.", valuesTitle: "Unsere Werte", v1: "Leidenschaft für Marokko", v1d: "Lokales Team, das das Land liebt.", v2: "Garantierte Qualität", v2d: "Strenge Auswahl von Riads und Partnern.", v3: "Verantwortungsvoller Tourismus", v3d: "Unterstützung lokaler Gemeinschaften.", v4: "Persönliche Betreuung", v4d: "Menschliche Begleitung bei jedem Schritt.", testimonialsTitle: "Was unsere Kunden sagen", ctaTitle: "Bereit, Marokko zu entdecken?", ctaText: "Wir gestalten Ihre Reise nach Maß. Unverbindlich." },
  contact: { errorMessage: "Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.", metaTitle: "Kontakt und Buchungen — Marokko Reisen", heroEyebrow: "Kontakt", heroTitle: "Wir helfen Ihnen bei der Reiseplanung", heroDesc: "Sagen Sie uns, was Sie suchen, und wir senden Ihnen innerhalb von 24 Stunden ein personalisiertes Angebot.", name: "Vollständiger Name", namePh: "Ihr Name", email: "E-Mail", phone: "Telefon", people: "Reisende", dateOut: "Abreisedatum", dateBack: "Rückreisedatum", tripType: "Reiseart", t1: "Komplettpaket", t2: "Nur Unterkunft", t3: "Einzelnes Erlebnis", t4: "Maßgeschneiderte Reise", prefs: "Erzählen Sie uns Ihre Wünsche", prefsPh: "Interessen, ungefähres Budget, Essensvorlieben...", thanks: "Vielen Dank! Wir melden uns innerhalb von 24 Stunden.", office: "Büro", hours: "Öffnungszeiten", hoursVal1: "Montag bis Sonntag", hoursVal2: "9:00 – 20:00 Uhr", mapLabel: "Standortkarte" },
  detail: { description: "Beschreibung", includes: "Was ist inbegriffen", itinerary: "Reiseroute", info: "Praktische Infos", reviews: "Bewertungen", amenities: "Ausstattung", location: "Lage", schedule: "Zeitplan", perPerson: "pro Person", perNight: "pro Nacht", from: "ab", date: "Datum", datePh: "Datum auswählen", people: "Reisende", p1: "1 Person", p2: "2 Personen", p3: "3 Personen", p4: "4+ Personen", freeCancel: "Kostenlose Stornierung", instantConfirm: "Sofortige Bestätigung", securePay: "Sichere Zahlung", others: "Weitere Erlebnisse, die Sie interessieren könnten", duration: "Ungefähre Dauer", expIntro: "Ein authentisches Erlebnis, das Sie mit lokalen Experten in die marokkanische Kultur eintauchen lässt.", incGuide: "Zertifizierter lokaler Reiseführer", incMaterial: "Material und Eintrittskarten", incDrink: "Traditionelles Getränk", incTransport: "Transport (wo zutreffend)", scheduleText: "Passt sich Ihrer Ankunft und der Verfügbarkeit lokaler Reiseführer an.", stayDesc1: "Erleben Sie eine einzigartige Entspannung in einem authentischen marokkanischen {{type}}.", stayDesc2: "Lassen Sie sich von uralten Wellness-Ritualen mitreißen. Ein perfekter Moment zum Abschalten.", stayInc1: "Zugang zum traditionellen Hammam", stayInc2: "Peeling mit schwarzer Seife", stayInc3: "Entspannende Arganöl-Massage", stayInc4: "Minztee und marokkanisches Gebäck", stayLocation: "Gelegen in {{city}}, in der Nähe der schönsten lokalen Ecken, mit Transfers auf Anfrage.", packDesc1: "Erleben Sie eine einzigartige Reise durch {{city}} mit einem sorgfältig geplanten Reiseprogramm. {{short}}.", packDesc2: "Lassen Sie sich von den Düften der Souks, der Stille der Wüste und der Wärme der marokkanischen Gastfreundschaft mitreißen.", packInc1: "Flughafentransfers", packInc2: "Unterkunft im Riad", packInc3: "Zertifizierter lokaler Reiseführer", packInc4: "Wüstenausflug", packInc5: "Kulturelle Aktivitäten", packInc6: "Tägliches Frühstück", day: "Tag" },
  gallery: { prev: "Vorheriges Bild", next: "Nächstes Bild" },
  format: { days_one: "Tag", days_other: "Tage", nights_one: "Nacht", nights_other: "Nächte" },
  packType: { Cultural: "Kulturell", Aventura: "Abenteuer", Lujo: "Luxus", Familiar: "Familie" },
  stayType: { Riad: "Riad", Hotel: "Hotel", Boutique: "Boutique" },
  expCategory: { all: "Alle", Bienestar: "Wellness", "Gastronomía": "Gastronomie", Cultural: "Kulturell", Aventura: "Abenteuer" },
  amenity: { Desayuno: "Frühstück", "Wi-Fi": "WLAN", Piscina: "Pool", Terraza: "Terrasse" },
  ...
  destBlurb: { marrakech: "Die rote Stadt, Souks und Paläste", fez: "Mittelalterliche Medina, Kunst und Handwerk", chefchaouen: "Das blaue Dorf in den Bergen", sahara: "Dünen, Kamele und Sternennächte" },
  packCatalog: {
    "marrakech-desierto": { name: "Marrakesch & Wüste", short: "Luxus-Riad + Nacht im Berberzelt" },
    "ruta-imperial": { name: "Kaiserliche Route", short: "Marrakesch, Fès, Meknès und Rabat" },
    "ciudades-imperiales": { name: "Kaiserliche Städte", short: "Vollständiges Rundum-Paket" },
    "aventura-sahara": { name: "Sahara-Abenteuer", short: "Merzouga, Dünen und Luxus-Bivouac" },
    "gran-tour": { name: "Große Marokko-Rundreise", short: "Die vollständigste Tour des Landes" },
    "escapada-chef": { name: "Chefchaouen-Ausflug", short: "Blaues Dorf + Nordroute" },
  },
  stayCatalog: {
    "riad-lorangerie": { name: "Riad L'Orangerie" },
    "riad-fes-relais": { name: "Riad Fès Relais" },
  ...
  expCatalog: {
    ...
    "excursion-desierto": { name: "Wüstenausflug", short: "Kamele, Dünen und Sonnenuntergang" },
    "tour-medina-2": { name: "Fès Medina-Tour", short: "Entdecken Sie die älteste Medina" },
    "ruta-atlas": { name: "Atlasgebirge-Route", short: "Berberdörfer und Berge" },
  },
};
...
const it = {
  ...
  cta: { reservar: "Prenota ora", verPacks: "Vedi pacchetti", verTodos: "Vedi tutti i pacchetti", contactar: "Contatta gli esperti", planificar: "Pianifica il mio viaggio", buscar: "Cerca viaggio", favoritos: "Aggiungi ai preferiti", compartir: "Condividi", compartido: "Link copiato!", verDetalles: "Vedi dettagli", filtrar: "Filtra", limpiar: "Azzera filtri", enviar: "Invia messaggio" },
  hero: { eyebrow: "Marocco · Viaggi autentici", title1: "Scopri il Marocco", title2: "come mai prima", subtitle: "Viaggi tutto incluso: trasferimenti, riad, esperienze autentiche e assistenza personalizzata.", destino: "Destinazione", destinoPh: "Dove vuoi andare?", fechas: "Date", personas: "Viaggiatori" },
  sections: { destinosEyebrow: "Destinazioni popolari", destinosTitle: "Luoghi di cui innamorarsi", packsEyebrow: "Pacchetti più popolari", packsTitle: "La tua prossima avventura", ctaEyebrow: "Hai bisogno di qualcosa di personalizzato?", ctaTitle: "Creiamo il tuo viaggio su misura", ctaText: "Raccontaci le tue date, interessi e budget. Progettiamo un itinerario unico per te.", readyEyebrow: "Pronto per la tua avventura?", readyTitle: "Esplora i nostri pacchetti e vivi il Marocco al massimo." },
  bullets: { precio: "Miglior prezzo garantito", atencion: "Assistenza 24/7", personal: "Viaggi 100% personalizzati", sinCargos: "Nessun costo nascosto", pago: "Pagamento sicuro" },
  ...
  footer: { tagline: "La tua avventura in Marocco inizia qui", about: "Specialisti in viaggi autentici in Marocco. Riad, deserto, gastronomia e cultura.", destinos: "Destinazioni", paginas: "Pagine", boletin: "Newsletter", boletinText: "Ricevi offerte esclusive e novità dal Marocco.", emailPh: "La tua email", rights: "© 2026 Marruecos Viajes Auténticos. Tutti i diritti riservati.", privacy: "Informativa sulla privacy", terms: "Termini e condizioni" },
  packs: { metaTitle: "Pacchetti viaggio Marocco — Tutto incluso", heroEyebrow: "Tutto incluso", heroTitle: "I nostri pacchetti viaggio", heroDesc: "Trasferimento, alloggio, esperienze e guida locale — ogni dettaglio curato.", duration: "Durata", anyDuration: "Qualsiasi durata", price: "Prezzo", anyPrice: "Qualsiasi prezzo", city: "Città", anyCity: "Tutte le città", expType: "Tipo di esperienza", anyType: "Tutte le esperienze", days1to3: "1-3 giorni", days4to6: "4-6 giorni", days7plus: "7+ giorni", priceLt: "Economico", priceMid: "Standard", priceGt: "Premium", noResults: "Nessun pacchetto per questi filtri", popular: "Popolare", from: "da", nights: "notti", results: "risultato", results_plural: "risultati" },
  stays: { metaTitle: "Alloggi in Marocco — Riad, hotel e boutique", heroEyebrow: "Dove alloggiare", heroTitle: "Alloggi unici in Marocco", heroDesc: "Riad tradizionali, hotel boutique ed esperienze indimenticabili.", destination: "Destinazione", anyDest: "Tutte le destinazioni", typeLabel: "Tipo di alloggio", anyTypeLabel: "Tutti", maxPrice: "Prezzo max", perNight: "/notte", services: "Servizi", anyService: "Qualsiasi servizio", noResults: "Nessun alloggio per questi filtri", reviews: "recensioni" },
  ...
  destinos: { metaTitle: "Destinazioni in Marocco — Marrakech, Fès, Chefchaouen e altro", heroEyebrow: "Esplora", heroTitle: "Destinazioni imperdibili", heroDesc: "Dalle medine medievali alle infinite dune del Sahara.", selectPrompt: "Clicca su una destinazione per vedere tutto il disponibile", packsHere: "Pacchetti in questa destinazione", staysHere: "Alloggi disponibili", expsHere: "Esperienze da vivere", viewAll: "Vedi tutto", noItems: "Altre opzioni presto disponibili" },
  about: { metaTitle: "Chi siamo — Marruecos Viajes Auténticos", heroEyebrow: "Chi siamo", heroTitle: "Esperti nella creazione di viaggi indimenticabili", heroDesc: "Siamo un team locale appassionato di condividere la magia e l'autenticità del Marocco.", missionTitle: "La nostra missione", missionP1: "Offrire esperienze uniche e personalizzate, curando ogni dettaglio perché possiate vivere il Marocco nel modo più autentico.", missionP2: "Lavoriamo con guide locali, riad a conduzione familiare e artigiani del paese affinché il vostro viaggio abbia un'anima.", valuesTitle: "I nostri valori", v1: "Passione per il Marocco", v1d: "Team locale che vive e ama il paese.", v2: "Qualità garantita", v2d: "Selezione rigorosa di riad e partner.", v3: "Turismo responsabile", v3d: "Supporto alle comunità locali.", v4: "Attenzione personale", v4d: "Accompagnamento umano ad ogni passo.", testimonialsTitle: "Cosa dicono i nostri clienti", ctaTitle: "Pronti a scoprire il Marocco?", ctaText: "Progettiamo il tuo viaggio su misura. Senza impegno." },
  contact: { errorMessage: "Si è verificato un errore. Riprova.", metaTitle: "Contatti e prenotazioni — Marocco Viaggi", heroEyebrow: "Contatti", heroTitle: "Siamo qui per aiutarti a pianificare il tuo viaggio", heroDesc: "Raccontaci cosa cerchi e ti invieremo una proposta personalizzata entro 24 ore.", name: "Nome completo", namePh: "Il tuo nome", email: "Email", phone: "Telefono", people: "Viaggiatori", dateOut: "Data di partenza", dateBack: "Data di ritorno", tripType: "Tipo di viaggio", t1: "Pacchetto tutto incluso", t2: "Solo alloggio", t3: "Esperienza singola", t4: "Viaggio su misura", prefs: "Raccontaci le tue preferenze", prefsPh: "Interessi, budget approssimativo, preferenze alimentari...", thanks: "Grazie! Ti contatteremo entro 24 ore.", office: "Ufficio", hours: "Orari di apertura", hoursVal1: "Lunedì a Domenica", hoursVal2: "9:00 – 20:00", mapLabel: "Mappa della posizione" },
  detail: { description: "Descrizione", includes: "Cosa è incluso", itinerary: "Itinerario", info: "Informazioni pratiche", reviews: "Recensioni", amenities: "Servizi", location: "Posizione", schedule: "Orario", perPerson: "a persona", perNight: "a notte", from: "da", date: "Data", datePh: "Seleziona data", people: "Viaggiatori", p1: "1 persona", p2: "2 persone", p3: "3 persone", p4: "4+ persone", freeCancel: "Cancellazione gratuita", instantConfirm: "Conferma immediata", securePay: "Pagamento sicuro", others: "Altre esperienze che potrebbero interessarti", duration: "Durata approssimativa", expIntro: "Un'esperienza autentica progettata per immergerti nella cultura marocchina con esperti locali.", incGuide: "Guida locale certificata", incMaterial: "Materiale e biglietti", incDrink: "Bevanda tradizionale", incTransport: "Trasporto (dove applicabile)", scheduleText: "Si adatta al tuo arrivo e alla disponibilità delle guide locali.", stayDesc1: "Vivi un'esperienza unica di relax in un autentico {{type}} marocchino.", stayDesc2: "Lasciati trasportare dai rituali ancestrali del benessere. Un momento perfetto per disconnettersi.", stayInc1: "Accesso all'hammam tradizionale", stayInc2: "Esfoliazione con sapone nero", stayInc3: "Massaggio rilassante all'olio di argan", stayInc4: "Tè alla menta e dolci marocchini", stayLocation: "Situato a {{city}}, vicino agli angoli più caratteristici, con trasferimenti disponibili su richiesta.", packDesc1: "Vivi un'esperienza unica esplorando {{city}} con un itinerario curato nei minimi dettagli. {{short}}.", packDesc2: "Lasciati trasportare dai profumi dei souk, dal silenzio del deserto e dal calore dell'ospitalità marocchina.", packInc1: "Trasferimenti aeroportuali", packInc2: "Alloggio in riad", packInc3: "Guida locale certificata", packInc4: "Escursione nel deserto", packInc5: "Attività culturali", packInc6: "Colazione giornaliera", day: "Giorno" },
  ...
  packType: { Cultural: "Culturale", Aventura: "Avventura", Lujo: "Lusso", Familiar: "Famiglia" },
  stayType: { Riad: "Riad", Hotel: "Hotel", Boutique: "Boutique" },
  expCategory: { all: "Tutte", Bienestar: "Benessere", "Gastronomía": "Gastronomia", Cultural: "Culturale", Aventura: "Avventura" },
  amenity: { Desayuno: "Colazione", "Wi-Fi": "Wi-Fi", Piscina: "Piscina", Terraza: "Terrazza" },
  city: { Marrakech: "Marrakech", Fez: "Fès", Chefchaouen: "Chefchaouen", Merzouga: "Merzouga", Essaouira: "Essaouira" },
  ...
  packCatalog: {
    "marrakech-desierto": { name: "Marrakech & Deserto", short: "Riad di lusso + notte in tenda berbera" },
  ...
  expCatalog: {
    ...
    "excursion-desierto": { name: "Escursione nel deserto", short: "Cammelli, dune e tramonto" },
    "tour-medina-2": { name: "Tour della Medina di Fès", short: "Scopri la medina più antica" },
    "ruta-atlas": { name: "Rotta dell'Atlante", short: "Villaggi berberi e montagne" },
  },
};
